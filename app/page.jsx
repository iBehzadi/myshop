...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center px-4 sm:px-6 py-8 sm:py-12 space-y-10">
      {/* ---------- Hero Section ---------- */}
        ...
        <div className="flex flex-col md:flex-row items-stretch">
          ...
          <div className="flex-1 px-6 py-10 sm:px-10 sm:py-14 md:px-12 md:py-16 flex flex-col justify-center order-2 md:order-1">
            ...
            <p className="text-base sm:text-lg text-gray-600 max-w-md mb-6">
              Discover the latest products curated just for you. Quality meets
      ...
      <section className="w-full max-w-6xl">
        ...
        {/* The enhanced Carousel (with dots, fade, discount badge, etc.) */}
